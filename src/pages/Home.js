  ...
  return <Container style={{ height: "100vh" }}>
    <Row>
      ...
      <Col md='6'>
        ...
        <Row className='justify-content-center '><p style={{ fontFamily: "Source Sans Pro sans-serif", fontSize: '20px', lineHeight: '26.6px', textAlign: 'center', letterSpacing: 'normal', color: '#282d38' }}>I'm a GCP Cloud Consultant with work experience in software engineering and development. I hold a Master's Degree in Applied Computer Science from the University of Urbino "Carlo Bo".
