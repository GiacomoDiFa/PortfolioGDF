...
import { SiFlutter, SiGooglecloud, SiIntellijidea, SiMacos } from 'react-icons/si'
...
import { FaAngular, FaErlang } from 'react-icons/fa'
...
function About() {
  return (
    <Container>
      ...
      <Row className="justify-content-center">
          <Col md="3" xs="6" className="p-2">
          <CardLanguageGreen icon={<SiGooglecloud size={100} />} />
        </Col>
        <Col md="3" xs="6" className="p-2">
          <CardLanguageGreen icon={<SiVisualstudiocode size={100} />} />
        </Col>
        <Col md="3" xs="6" className="p-2">
          <CardLanguageGreen icon={<SiIntellijidea size={100} />} />
        </Col>
        <Col md="3" xs="6" className="p-2">
          <CardLanguageGreen icon={<FaAngular size={100} />} />
        </Col>
        <Col md="3" xs="6" className="p-2">
